...
import torch
import gan_files.models as models
import data as data
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='gan_files/datasets', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--load_size', type=int, default=224, help='scale images to this size')  # default 286
        parser.add_argument('--crop_size', type=int, default=224, help='then crop to this size') #default 256
